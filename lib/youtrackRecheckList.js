...
export default youtrackRecheckList;
...
function checkAndRun () {
  const SCRIPT = document.querySelector('script[src *= "youtrackRecheckList.js"]');
  // Was: const SCRIPT = document.querySelector('script[src *= "youtrackRecheckList.js"][src *= "run=true"]');
